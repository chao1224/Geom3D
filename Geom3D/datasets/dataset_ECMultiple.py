...
class DatasetECMultiple(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None, split='train', percent=0.3):
        ...
        super(DatasetECMultiple, self).__init__(
    ...
    def processed_dir(self):
        if self.split != "test":
            name = 'processed_ECMultiple_{}'.format(self.split)
            return osp.join(self.root, name)
        else:
            name = 'processed_ECMultiple_test_{}'.format(self.percent)
            return osp.join(self.root, name)
    ...
    def process(self):  
        ...
        invalid_PDB_file_name_list = ["2UV2-A_16534.pdb", "1ENM-A_16555.pdb", "1DIN-A_7896.pdb"]
