...
class MQAModel(nn.Module):
    ...
    def __init__(
        ...
        seq_in=False, num_layers=3, drop_rate=0.1, out_channels=1195):
    ...
    def forward(self, seq=None, batch=None):      
        '''
        ...
        h_V = (batch.node_s, batch.node_v) # tuple (s, V) of node embeddings
        h_E = (batch.edge_s, batch.edge_v) # tuple (s, V) of edge embeddings
        ...
        else: out = torch_scatter.scatter_mean(out, batch.batch, dim=0)
