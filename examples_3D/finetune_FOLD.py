...
from Geom3D.datasets import DatasetFOLD, DatasetGVP, DatasetFOLDGearNet
...
def train(epoch, device, loader, optimizer):
    ...
    for step, batch in enumerate(L):
        ...
        if args.model_3d == "GVP":
            ...
            molecule_3D_repr = model(batch.coords_n, batch.coords_ca, batch.coords_c, batch.seq, batch.batch, split="training")
...
if __name__ == "__main__":
    ...
    if args.model_3d in ["GearNet", "GearNet_IEConv"]:
        dataloader_kwargs["collate_fn"] = DatasetFOLDGearNet.collate_fn
